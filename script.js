...
const noStages = [
  ...
  {
    text: "Даже мой кот расстроился! 🐱💧", yesText: "Ради кота — да! 🐱", noText: "Мяу нет",
    title: "Нажми уже «Да»! 💝",
    fx(y, n) {
...
function startComplimentCarousel() {
  const compliments = [
    ...
    "Каждый день рядом с тобой — праздник 🎉",
...
function initSecretNote() {
  ...
  const secrets = [
    "Ульяшка, ты даже не представляешь, как сильно ты изменила мою жизнь. Каждый раз, когда вижу тебя, сердце стучит быстрее. Это не просто слова — это правда. ❤️",
